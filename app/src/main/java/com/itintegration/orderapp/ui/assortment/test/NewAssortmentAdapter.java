...
import com.itintegration.orderapp.data.test.DataProvider;
import com.itintegration.orderapp.ui.test.ExpandableItemIndicator;

class NewAssortmentAdapter extends AbstractExpandableItemAdapter<NewAssortmentAdapter.MyGroupViewHolder, NewAssortmentAdapter.MyChildViewHolder> {
    private static final String TAG = "AssortmentAdapter";
    ...
    public NewAssortmentAdapter(AbstractDataProvider dataProvider) {
